...
17. **Heimaskjá-fínpússun (lota 5b):**
    - **Listavalmynd opin við innskráningu** — `showLists` er false sjálfgefið og ekkert opnar hana í kóða, en til öryggis lokar nú effect henni þegar `view==='home'` (þ.e. við innskráningu). Ef vandinn er viðvarandi gæti verið gömul skyndiminnis-útgáfa.
